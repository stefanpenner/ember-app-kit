module.exports = function(grunt) {
  ...
  grunt.registerTask('build', [
    'clean:build',
    'lock',
    // Uncomment line below & `npm install --save-dev grunt-contrib-coffee` 
    ...
    'jshint',
    'copy:stage',
    // Uncomment line below & `npm install --save-dev grunt-sass` for SASS 
    // (SCSS only) support. Or run `npm install --save-dev grunt-contrib-sass` 
    // for SCSS/SASS support (may be slower). Delete `public/assets/app.css` 
    // and create `app/styles/app.scss` instead.
    // 'sass:compile',
    // Uncomment line below & `npm install --save-dev grunt-contrib-compass`
    // for Compass support. You don't need SASS if you have Compass.
    'compass:compile',
    // Uncomment line below & `npm install --save-dev grunt-contrib-less` 
    // for LESS support.
    // 'less:compile'
    // Uncomment line below & `npm install --save-dev grunt-contrib-stylus` for stylus/nib support.
    // 'stylus:compile'
    'concat_sourcemap',
    'unlock' ]);
